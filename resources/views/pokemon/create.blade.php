...
@section('content')
    ...
    <form class="max-w-sm mx-auto" action="{{ url('pokemon') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-5">
            ...
            <input type="file" name="image" id="image" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" required>
        </div>
        <div class="mb-5">
        ...
        <br>
        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">Create Pokemon</button>
      </form>
